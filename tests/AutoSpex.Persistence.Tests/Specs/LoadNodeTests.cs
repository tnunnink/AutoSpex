...
{
    [Test]
    public async Task LoadNode_NoRecordOfNode_ShouldReturnSuccessButNoDataLoadedBecauseItDidntFindAny()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
        var node = Node.NewCollection();

        var result = await mediator.Send(new LoadNode(node));
    ...
    [Test]
    public async Task LoadNode_EmptyCollectionNode_ShouldReturnSuccessAndEquivalent()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
        ...
        var result = await mediator.Send(new LoadNode(seed));
    ...
    [Test]
    public async Task LoadNode_EmptyFolderNode_ShouldReturnSuccessAndEquivalent()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
    ...
    [Test]
    public async Task LoadNode_SpecNode_ShouldReturnSuccess()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
    ...
    [Test]
    public async Task LoadNode_ConfiguredSpecNode_ShouldReturnSuccessAndExpectedValues()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
        var seed = Node.NewSpec("Test");
    ...
    [Test]
    public async Task LoadNode_NodeWithVariables_ShouldReturnSuccess()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
        var seed = Node.NewCollection("TestCollection");
    ...
    [Test]
    public async Task LoadNode_NodeWithParentsAndVariablesAndSpec_ShouldReturnSuccess()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
        ...
        var result = await mediator.Send(new LoadNode(spec));
    ...
    [Test]
    public async Task LoadNode_HasFiltersButNoVerification_ShouldReturnSuccessAndExpectedCounts()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
    ...
    [Test]
    public async Task LoadNode_HasVerificationButNoFilter_ShouldReturnSuccessAndExpectedCounts()
    {
        using var context = new TestContext();
        var mediator = context.Resolve<IMediator>();
