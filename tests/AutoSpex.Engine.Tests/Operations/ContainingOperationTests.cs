...
public class ContainingOperationTests
{
    ...
    [Test]
    public void Execute_CollectionArgDoesContain_ShouldBeTrue()
    {
    ...
    [Test]
    public void Execute_CollectionArgDoesNotContain_ShouldBeFalse()
    {
        var items = new List<int> {1, 2, 3, 4, 5};
    ...
    [Test]
    public void Execute_CollectionStringArgDoesContain_ShouldBeTrue()
    {
    ...
    [Test]
    public void Execute_CollectionStringArgDoesNotContain_ShouldBeFalse()
    {
        var items = new List<string> {"One", "Two", "Three"};
