...
[UsedImplicitly]
public partial class NewProjectViewModel(IDialogService dialog) : ViewModelBase, IModalDialogViewModel, ICloseable
{
    [ObservableProperty]
    [NotifyDataErrorInfo]
    ...
    {
        var path = await dialog.ShowSelectFolderDialog("Select Project Location");
