...
public class DetailsOpenTabs : TemplatedControl
{
    ...
    public DetailsOpenTabs()
    {
        _source.Connect().Bind(out _openTabs).Subscribe();
        OpenTabsSourceProperty.Changed.AddClassHandler<DetailsOpenTabs>((c, a) => c.OnOpenTabsSourcePropertyChanged(a));
    }

    public static readonly DirectProperty<DetailsOpenTabs, ObservableCollection<PageViewModel>> OpenTabsSourceProperty =
        AvaloniaProperty.RegisterDirect<DetailsOpenTabs, ObservableCollection<PageViewModel>>(
            nameof(OpenTabsSource), o => o.OpenTabsSource, (o, v) => o.OpenTabsSource = v);

    public static readonly DirectProperty<DetailsOpenTabs, ICommand?> CloseTabCommandProperty =
        AvaloniaProperty.RegisterDirect<DetailsOpenTabs, ICommand?>(
