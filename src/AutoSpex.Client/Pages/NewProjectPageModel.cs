...
[UsedImplicitly]
public partial class NewProjectPageModel : PageViewModel
{
    [ObservableProperty]
    [NotifyDataErrorInfo]
    [NotifyCanExecuteChangedFor(nameof(CreateCommand))]
    [Required]
    [CustomValidation(typeof(NewProjectPageModel), nameof(ValidateFileName))]
    ...
    [NotifyCanExecuteChangedFor(nameof(CreateCommand))]
    [Required]
    [CustomValidation(typeof(NewProjectPageModel), nameof(ValidateDirectoryName))]
    ...
    private void Cancel()
    {
        //todo in reality would it not be nice to nav back? not a big deal right now.
