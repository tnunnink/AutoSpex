...
public class SplitGrid : ContentControl
{
    ...
    /// </summary>
    public static readonly StyledProperty<SplitGridPanePlacement> PanePlacementProperty =
        AvaloniaProperty.Register<SplitView, SplitGridPanePlacement>(nameof(PanePlacement));
    ...
    /// <summary>
    /// Gets or sets the <see cref="SplitGridPanePlacement"/> for the SplitView
    /// </summary>
    public SplitGridPanePlacement PanePlacement
    {
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            UpdateVisualStateForPanePlacementProperty(change.GetNewValue<SplitGridPanePlacement>());
        }
    ...
    /// <summary>
    /// Gets the appropriate PseudoClass for the given <see cref="SplitGridPanePlacement"/>.
    /// </summary>
    private static string GetPseudoClass(SplitGridPanePlacement placement)
    {
        return placement switch
        {
            SplitGridPanePlacement.Left => pcLeft,
            SplitGridPanePlacement.Right => pcRight,
    ...
    private void UpdateVisualStateForPanePlacementProperty(SplitGridPanePlacement newValue)
    {
    ...
    {
        if (instance is SplitGrid splitGrid)
        {
            return splitGrid.OnCoerceIsPaneOpen(value);
        }
