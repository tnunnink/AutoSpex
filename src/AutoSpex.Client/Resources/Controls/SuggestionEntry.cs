...
public class SuggestionEntry : TemplatedControl
{
    ...
    public static readonly StyledProperty<object?> ValueProperty =
        AvaloniaProperty.Register<SuggestionEntry, object?>(
    ...
    public static readonly StyledProperty<IDataTemplate?> ValueTemplateProperty =
        AvaloniaProperty.Register<SuggestionEntry, IDataTemplate?>(
            nameof(ValueTemplate));

    public static readonly StyledProperty<string?> TextProperty =
        AvaloniaProperty.Register<SuggestionEntry, string?>(
            nameof(Text));
    ...
    public static readonly StyledProperty<bool> IsEmptyProperty =
        AvaloniaProperty.Register<SuggestionEntry, bool>(
            nameof(IsEmpty));
    ...
    public static readonly StyledProperty<int> MaxDropDownHeightProperty =
        AvaloniaProperty.Register<SuggestionEntry, int>(
    ...
    public static readonly StyledProperty<Func<string?, CancellationToken, Task<IEnumerable<object>>>?>
        PopulateProperty =
            AvaloniaProperty.Register<SuggestionEntry, Func<string?, CancellationToken, Task<IEnumerable<object>>>?>(
                nameof(Populate));

    public static readonly StyledProperty<Func<object?, string>?> SelectorProperty =
        AvaloniaProperty.Register<SuggestionEntry, Func<object?, string>?>(
            nameof(Selector));

    public static readonly StyledProperty<Action<object?>?> CommitProperty =
        AvaloniaProperty.Register<SuggestionEntry, Action<object?>?>(
            nameof(Commit));
    ...
    static SuggestionEntry()
    {
        PointerReleasedEvent.AddClassHandler<SuggestionEntry>((e, a) => e.HandlePointerReleased(a), RoutingStrategies.Tunnel);
    }
    ...
    /// <summary>
    /// Registers the SuggestionEntry text box and attaches the key down event handler to handler navigation of the suggestion list.
    /// </summary>
    ...
    /// value but not close the flyout. This allows effectively updates the text SuggestionEntry with the selected value and allows
    /// continuation of field SuggestionEntry, which we need to dot down path SuggestionEntry.
    /// </summary>
    ...
    /// <summary>
    /// Sets the caret of the SuggestionEntry text box to the end of the string.
    /// </summary>
    ...
    /// object this SuggestionEntry represents, which is expected to be the content of the control.
    /// </summary>
