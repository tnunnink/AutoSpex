...
/// <summary>
/// Performs a migration of the provided <see cref="Persistence.Project"/>. This will first attempt to create a backup
...
/// </summary>
/// <param name="Project">The <see cref="Persistence.Project"/> to migrate.</param>
[PublicAPI]
